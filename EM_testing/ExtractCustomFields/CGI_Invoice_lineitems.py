        ...
        if(final_dict['Quantity']!=[]):
            ...
            for i in final_dict['Quantity']:
                ...
                if('manpower' in i['Description'].lower()):
                    ...
                    t=re.sub(r'^\s*(Manpower|manpower|Man-power)',"",i['Description'])
                    tt=(t.split('('))[0]
                    tt=re.sub(r'[-]'," ",tt)
                    temp['Subcat']=tt
                    ...
                    ttt = re.search(r'^(\s*[a-z|A-Z|-|/]\s*)+[;]', i['Description'])[0]
                    tt = re.sub(r'[;]', "", ttt)
                    temp['Category'] = tt
...
# inp_path = r'/datadrive/EM_Product/ips/invoiceProduct_solution/EM_output/CGI/CHEM-US/303315/Inv303315.text'
inp_path = r'/datadrive/EM_Product/ips/invoiceProduct_solution/EM_output/CGI/US/307872/Inv 307872.text'

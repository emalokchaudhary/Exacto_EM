...
# file=open(r'/datadrive/EM_Product/ips/invoiceProduct_solution/EM_output/Saybolt/EU/1200140896/20E535549v.1.text','r',encoding='windows-1258')
# read=file.read()
# lines=read.split('\n')
'''@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@'''
...
def parcel_data(lines):
    ...
    # print(table_content)
    keys=['VesselName','JobLocation','ActivityType','ProductName','JobDate','VendorName','Type of Inspection','NominatedQuantity','UnitOfMeasure','EmAffiliates','NominationKey']
    partial_data=[]
    ...
    # print('Here is the output',last_list)
    return last_list

# a = parcel_data(lines)
# print('Here is the output',a)

...
def FinalQuantityLineItems(read):
...
path = open(r'/datadrive/EM_Product/ips/invoiceProduct_solution/EM_output/Saybolt/EU/1030062902/FullReport1030400003526-ESSODEUTSCHLANDGMBH,N.Spanos.text')
read  = path.read()

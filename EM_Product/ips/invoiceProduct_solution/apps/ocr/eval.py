...
if platform.system()=='Windows':
	from ocr.merge import merge_main_win as merge_main
else:
	from ocr.merge import merge_main_linux as merge_main
...
def detect(score_map, geo_map, score_map_thresh=0.8, box_thresh=0.1, nms_thres=0.2):
    ...
    boxes = merge_main(boxes.astype('float32'), nms_thres)
    ...
    print('{} text boxes detected'.format(boxes.shape[0]))
    return boxes

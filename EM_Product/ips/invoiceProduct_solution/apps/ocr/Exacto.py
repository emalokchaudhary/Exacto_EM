...
from pdfReadableMetaData.ExtractDataFromPDF_V7 import main_function
from pdfReadableTableExtractor.TRtableData_v3_2_1_output import singularity as createTable
...
from metaDataTypedMultiPage.MetadataFrmText import getFianllyDic as extractContent
...
from predictFuncROT import predictRotation
import subprocess
...
def checkFileType(filePath, outputPath, xmlDir):
    ...
    if typeDoc == TXT_FILE:
        ...
        try:
            ...
            print("Exception in HTML Table Extraction")
        ...
        try:
            ...
            xmlParser.appendTXTMetaDataXML(metaDataDict, xmlFilePath, isHTML=True)
        except:
            pass
        ...
        try:
            # Raushan Solution
            tableDict = Extract_Table_OCR_FS(folderPath)
            xmlParser.appendFullyScannedTableXML(tableDict, xmlFilePath)
        except:
            pass
...
def processDocument(inputPathPara, outputPathPara, xmlDirPara):
    ...
    for sample in samplesList:
        ...
        try:
            ...
            # print("Processed in " + str(time.clock() - startTime) + " Seconds")

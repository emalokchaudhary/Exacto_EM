...
def Trip_Nomination(data):
    fields_nomination={"TripNumber":"NA","NominationNumber":"NA"}
    for k,line in enumerate(data):
        ...
        if match:
            ...
            try: 
                ...
                fields_nomination["TripNumber"]= hor_data[0].strip()                
                fields_nomination["NominationNumber"]= (hor_data[1].strip().split(" "))[0]
                
                break
            except:
                print("erron in trip number)")
                fields_nomination["TripNumber"]="NA"
                fields_nomination["NominationNumber"]="NA"
...
def Nomination_header_field(text_data,uuid_doc):    
    ...
    try:
        ...
        Nomination_field_dict["doc_uuid"]= uuid_doc
    # Nomination_field_dict["status"]=0
        ...
        # else:
        #     print("vendor not match")
        #     pass
        logger.info(f'Header Data Nomination - {Nomination_field_dict}')
    except Exception as e :
        # print()
        logger.info("Error in Header data Nomination")
        logger.exception(e)
        print("ERROR IN EXTRACTION FILE FROM NOMINATION")
        traceback.print_exc()

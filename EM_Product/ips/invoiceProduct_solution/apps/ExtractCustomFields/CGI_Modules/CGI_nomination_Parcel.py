    ...
    for k,line in enumerate(data):
        ...
        if ("Inspector" in line) and (" Inspection Status" in line):
            ...
            try: 
                ...
                Activity=temp.split(":")
                # print(Activity,"Activity find  is")
                if len(Activity)>1:
                    # print(Activity)
                    ...
                    try:
                        ...
                        fields_activity["JobLocation"]=Activity[1]
...
def Nomination_field(text_data):
    ...
    if re.search('TRIP:'," ".join(data),re.IGNORECASE):
        ...
        Nomination_field_dict["TypeofInspection"]=Inspection_req(data)[0]
        try:
            Nomination_field_dict["EmAffiliates"]= bill_invoice_to(data)[0]
        except :
            print("dddddddd")
            Nomination_field_dict["EmAffiliates"]=''

...
# file=open(r'/datadrive/20E550932v.1.text','r',encoding='windows-1258')
# read=file.read()
# lines=read.split('\n')
'''@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@'''
...
def bill_invoice_to(data):
    ...
    for k,line in enumerate(data):
        ...
        if match:
            ...
            print("BILLLLLLLLLLLLLLLLLLL INVOOOOOOOOOOOOOO")
            print(data[k])
            print(data[k+1])
            print(data[k+2])
...
def parcel_data(lines):
    ...
    # print("Enter into parcel data function")
    for line in range(0,len(lines)):
        # print("insert into loop 1 ")
    ...
    # print(table_content)
    keys=['VesselName','JobLocation','ActivityType','ProductName','JobDate','VendorName','NominatedQuantity','UnitOfMeasure','EmAffiliates','NominationKey']
    partial_data=[]
    ...
    print("apppppppaaaaaaapppppppppppppp",last_list)
    return last_list
